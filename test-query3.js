const fs = require('fs');
fetch("https://wjixkrgakcjxtvhczwyf.supabase.co/rest/v1/mush_batches?select=id,readable_id,parent_id,parent:mush_batches(readable_id)&limit=5&parent_id=not.is.null", {
    headers: {
    ...
    fs.writeFileSync('C:\\Users\\Marcio\\Labels\\test-output3.json', JSON.stringify(data, null, 2));
