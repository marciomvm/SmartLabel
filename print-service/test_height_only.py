"""
Test with HEIGHT ONLY in SET_DIMENSION command
Some B1 firmware versions only accept height, not width
"""
import asyncio
...
async def test_print():
    ...
    async with BleakClient(target.address, timeout=30.0) as client:
        ...
        # SET_DIMENSION with HEIGHT ONLY (like some B1 versions)
        print("🔧 Setting dimension: HEIGHT ONLY (240)")
...
if __name__ == "__main__":
    print("=" * 60)
    print("🧪 TEST: HEIGHT ONLY in SET_DIMENSION")
    print("=" * 60)
    print("\nSome B1 firmware versions only accept height parameter.")
    print("This test sends: 0x13 with just HEIGHT (240)\n")
